                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $x++; ?></td>
                          <td><?php echo $row->masa_pajak; ?> - <?php echo $row->tahun ?></td>
                          ...
                          <td>
                              ...
                              <a href="<?php echo base_url('Dinas_resto/hapus_pajak/'.$row->id_resto) ?>"><button type="button" class="btn btn-danger" title="Hapus Data" onclick="return confirm('Data Akan dihapus?')"><i class="fa fa-trash"></i></button></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <form method="post" action="<?php echo base_url('Dinas_resto/tambah_pajak') ?>">
...
<div class="modal fade" id="myModalEdit<?php echo $y++; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                      <form method="post" action="<?php echo base_url('Dinas_resto/update_pajak/'.$row->id_resto) ?>">
                                        <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">Edit Data Pajak Restoran</h4>
                                        </div>
                                        <div class="modal-body">
