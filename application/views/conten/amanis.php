                      ...
                      if ($year = 0 || empty($year) && $bulan = 0 || empty($bulan)) {
                        ...
                        for ($i=date("n"); $i >= 1;$i--) {
                          ...
                          <tr>
                            ...
                            <?php 
                              $date = date('Y').'-'.$i;
                              $data = $this->db->query("SELECT SUM(nominal) AS jumlah FROM tbl_rm_amanis WHERE tgl_transaksi LIKE '%$date%';");
                              $x = 0;
                            ...
                            <td>
                              <a target="_new" href="<?php echo base_url('amanis/detail_rekap_bulanan?param='.$date.'') ?>"><button type="button" class="btn btn-primary"><i class="fa fa-list-alt"></i> Lihat Detail</button></a>
                            </td>
                          </tr>
                          <?php 
                        }
                        ...
                        for ($i=$bulan; $i >= 1;$i--) {
                          ...
                          <tr> 
                            ...
                            <td>
                              <a href="<?php echo base_url('amanis/detail_rekap_bulanan?param='.$date.'') ?>" target="_new"><button type="button" class="btn btn-primary"><i class="fa fa-list-alt"></i> Lihat Detail</button></a>
                            </td>
                          </tr>
                          <?php 
                        } 
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <form method="post" action="<?php echo base_url('amanis/tambah_pajak') ?>">
...
<div class="modal fade bs-example-modal-lg1" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg1">
                      <div class="modal-content">
                        <form method="post" action="<?php echo base_url('amanis/import')?>" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                          </button>
