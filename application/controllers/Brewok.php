...
class Brewok extends CI_Controller {
	...
	public function index()
	{
		...
		$data['conten'] 		= 'conten/brewok';
		$data['title'] 			= 'RM Ayam Brewok';
		$data['sumber']			= $this->M_data->get_data('tbl_rm_brewok');
	...
	{
		$data['name'] 			= $this->session->userdata('nama');
		$data['conten'] 		= 'conten/detail_rekap_brewok';
		$data['title'] 			= 'RM Ayam Brewok';
	...
	public function import()
	{
        ...
        $this->M_data->upload_data_brewok($filename);
